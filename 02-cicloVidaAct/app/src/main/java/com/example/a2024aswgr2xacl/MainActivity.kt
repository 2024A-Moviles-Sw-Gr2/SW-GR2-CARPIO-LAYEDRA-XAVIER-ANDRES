...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonIntentExplicito.setOnClickListener {
            ...
            intentExplicito.putExtra("apellido", "Carpio")
            intentExplicito.putExtra("edad", 21) // passing age as an integer
            intentExplicito.putExtra("entrenador",BEntrenador(10, "Xavier","Carpio"))
