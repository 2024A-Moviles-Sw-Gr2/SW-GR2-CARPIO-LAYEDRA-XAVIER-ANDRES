...
class BListView : AppCompatActivity() {
    val arreglo= BBaseDatosMemoria.arreBEntrenador
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.cl_blist_views)) { v, insets ->
    ...
    fun abrirDialogo(){
        ...
        val seleccionarPrevia= booleanArrayOf(true, //Lunes check
            false,   //Martes no check
            false)   //Miercoles no check
    ...
    fun mostrarSnackbar(texto:String){
        val snack=Snackbar.make(
            findViewById(R.id.cl_blist_views),
            texto,
